    ...
    return new Promise((resolve, reject) => {
      ...
      if (this._options.renderComposition) {
        this._compositionImage.render()
          .then((image) => {
            resolve({ differences, percentageDifference, threshold, passed, compositionImage: image, boxes, width, height })
          })
      } else {
        resolve({ differences, percentageDifference, threshold, passed, boxes, width, height })
      }
    })
  }
